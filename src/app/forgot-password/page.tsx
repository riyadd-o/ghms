...
function ForgotPasswordContent() {
  ...
  return (
    <div className="min-h-screen bg-luxury-black flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm rounded-xl border border-luxury-gold/20 bg-luxury-charcoal/40 p-8 shadow-2xl backdrop-blur-sm text-center">
          ...
          <form onSubmit={handleSendResetLink} className="space-y-6 text-left">
            <div>
              ...
              <input
                ...
                className="w-full rounded border border-luxury-gold/20 bg-luxury-black/50 py-3 px-4 text-sm text-white outline-none focus:border-luxury-gold transition-colors"
                required
              />
            </div>
            ...
            >
              {loading ? <div className="h-4 w-4 animate-spin rounded-full border-t-2 border-luxury-black" /> : "Send Reset Link"}
            </button>
          </form>
        )}
